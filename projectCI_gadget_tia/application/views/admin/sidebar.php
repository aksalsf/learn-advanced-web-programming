<main class="w-100 d-flex flex-wrap justify-content-around bg-dark p-5 min-vh-100">
    <!-- Sidebar -->
    <aside class="border border-light col-1 text-white p-5 d-flex flex-column align-items-center rounded">
